...
class MainWidget(RelativeLayout):
    from Projects.Galaxy.transforms import transform, transform_2D, transform_perspective
    from Projects.Galaxy.user_actions import keyboard_closed, on_keyboard_up, on_keyboard_down, on_touch_up, on_touch_down
